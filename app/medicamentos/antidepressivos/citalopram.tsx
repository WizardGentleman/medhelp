...
export default function CitalopramScreen() {
  return (
    <View style={styles.container}>
      <ScreenHeader title="Citalopram" />
      <View style={styles.content}>
        <View style={styles.infoCard}>
          <Text style={styles.medicineClass}>ISRS - Inibidor Seletivo da Recaptação de Serotonina</Text>
          <Text style={styles.description}>ISRS com bom perfil de tolerabilidade, usado em depressão e ansiedade.</Text>
