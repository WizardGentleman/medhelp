...
export default function DesvenlafaxinaScreen() {
  return (
    <View style={styles.container}>
      <ScreenHeader title="Desvenlafaxina" />
      <View style={styles.content}>
        <View style={styles.infoCard}>
          <Text style={styles.medicineClass}>IRSN - Inibidor da Recaptação de Serotonina e Noradrenalina</Text>
          <Text style={styles.description}>Metabólito ativo da venlafaxina, pode aumentar PA e FC.</Text>
