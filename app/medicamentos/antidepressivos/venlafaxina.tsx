...
export default function VenlafaxinaScreen() {
  return (
    <View style={styles.container}>
      <ScreenHeader title="Venlafaxina" />
      <View style={styles.content}>
        <View style={styles.infoCard}>
          <Text style={styles.medicineClass}>IRSN - Inibidor da Recaptação de Serotonina e Noradrenalina</Text>
          <Text style={styles.description}>IRSN dose-dependente, pode causar elevação de PA e FC.</Text>
