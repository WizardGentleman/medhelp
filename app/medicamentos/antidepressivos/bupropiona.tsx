...
export default function BupropionaScreen() {
  return (
    <View style={styles.container}>
      <ScreenHeader title="Bupropiona" />
      <View style={styles.content}>
        <View style={styles.infoCard}>
          <Text style={styles.medicineClass}>Agente Atípico</Text>
          <Text style={styles.description}>Inibe recaptação de dopamina e noradrenalina; risco de convulsão em altas doses.</Text>
