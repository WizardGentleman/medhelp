...
export default function BularioAntibioticoterapiaScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="Bulário da Antibioticoterapia" type="antibiotic" />
      
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          <View style={styles.infoCard}>
            <Text style={styles.infoTitle}>
              <Pill size={20} color="#0891B2" /> Bulário de Antibioticoterapia
            </Text>
          ...
          {selectedAntibiotic && (
            <View style={styles.resultContainer}>
              <View style={[styles.medicationCard, { borderColor: '#0891B2' }]}>
                <View style={[styles.medicationHeader, { backgroundColor: '#0891B2' }]}>
                ...
                <View style={styles.medicationContent}>
                  <View style={styles.doseSection}>
                    <Text style={styles.sectionTitle}>
                      <Activity size={18} color="#0891B2" /> Dose Habitual (Função Renal Normal)
                    </Text>
